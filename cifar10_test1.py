...
for rnd in range(fl_epoch):
    ...
    f=open('main_frac0.5_krum_lr0.05_1000epoch_cifar10_resnet18_100c_10a.txt','a')
    f.write(str(acc)+'\n')
    f.close()

    f=open('backdoor_frac0.5_krum_lr0.05_1000epoch_cifar10_resnet18_100c_10a.txt','a')
    f.write(str(poi_acc)+'\n')
    f.close()
